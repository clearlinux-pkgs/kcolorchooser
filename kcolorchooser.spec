...
Version  : 25.04.2
Release  : 82
URL      : https://download.kde.org/stable/release-service/25.04.2/src/kcolorchooser-25.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/kcolorchooser-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/kcolorchooser-25.04.2.tar.xz.sig
...
%setup -q -n kcolorchooser-25.04.2
cd %{_builddir}/kcolorchooser-25.04.2
pushd ..
cp -a kcolorchooser-25.04.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749515776
mkdir -p clr-build
pushd clr-build
