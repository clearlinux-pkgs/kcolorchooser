...
Source0  : https://download.kde.org/stable/release-service/23.08.0/src/kcolorchooser-23.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.0/src/kcolorchooser-23.08.0.tar.xz.sig
...
%prep
%setup -q -n kcolorchooser-23.08.0
cd %{_builddir}/kcolorchooser-23.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1693027672
mkdir -p clr-build
pushd clr-build
