...
Source0  : https://download.kde.org/stable/release-service/24.05.2/src/kcolorchooser-24.05.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.2/src/kcolorchooser-24.05.2.tar.xz.sig
...
%setup -q -n kcolorchooser-24.05.2
cd %{_builddir}/kcolorchooser-24.05.2
pushd ..
cp -a kcolorchooser-24.05.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720589942
mkdir -p clr-build
pushd clr-build
