...
Version  : 19.04.3
Release  : 10
URL      : https://download.kde.org/stable/applications/19.04.3/src/kcolorchooser-19.04.3.tar.xz
Source0  : https://download.kde.org/stable/applications/19.04.3/src/kcolorchooser-19.04.3.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.3/src/kcolorchooser-19.04.3.tar.xz.sig
...
%prep
%setup -q -n kcolorchooser-19.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562866390
mkdir -p clr-build
pushd clr-build
