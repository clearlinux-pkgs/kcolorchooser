...
Source0  : https://download.kde.org/stable/release-service/22.08.1/src/kcolorchooser-22.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.1/src/kcolorchooser-22.08.1.tar.xz.sig
...
%prep
%setup -q -n kcolorchooser-22.08.1
cd %{_builddir}/kcolorchooser-22.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662827750
mkdir -p clr-build
pushd clr-build
