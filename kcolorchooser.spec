...
Version  : 24.02.0
Release  : 63
URL      : https://download.kde.org/stable/release-service/24.02.0/src/kcolorchooser-24.02.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/kcolorchooser-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/kcolorchooser-24.02.0.tar.xz.sig
...
%prep
%setup -q -n kcolorchooser-24.02.0
cd %{_builddir}/kcolorchooser-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709334577
mkdir -p clr-build
pushd clr-build
