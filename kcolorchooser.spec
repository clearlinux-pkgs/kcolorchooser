...
Version  : 20.08.0
Release  : 22
URL      : https://download.kde.org/stable/release-service/20.08.0/src/kcolorchooser-20.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.08.0/src/kcolorchooser-20.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.0/src/kcolorchooser-20.08.0.tar.xz.sig
...
%prep
%setup -q -n kcolorchooser-20.08.0
cd %{_builddir}/kcolorchooser-20.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597778210
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kcolorchooser-20.08.0/COPYING %{buildroot}/usr/share/package-licenses/kcolorchooser/2807f3f1c4cb33b214defc4c7ab72f7e4e70a305
pushd clr-build
%make_install
popd
