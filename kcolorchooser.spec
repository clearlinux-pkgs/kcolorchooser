...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/kcolorchooser-22.08.0.tar.xz
...
%prep
%setup -q -n kcolorchooser-22.08.0
cd %{_builddir}/kcolorchooser-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661550429
mkdir -p clr-build
pushd clr-build
