...
Version  : 24.02.2
Release  : 65
URL      : https://download.kde.org/stable/release-service/24.02.2/src/kcolorchooser-24.02.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/kcolorchooser-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/kcolorchooser-24.02.2.tar.xz.sig
...
%setup -q -n kcolorchooser-24.02.2
cd %{_builddir}/kcolorchooser-24.02.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712934267
mkdir -p clr-build
pushd clr-build
