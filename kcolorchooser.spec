...
Version  : 24.12.0
Release  : 75
URL      : https://download.kde.org/stable/release-service/24.12.0/src/kcolorchooser-24.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.0/src/kcolorchooser-24.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.0/src/kcolorchooser-24.12.0.tar.xz.sig
...
%setup -q -n kcolorchooser-24.12.0
cd %{_builddir}/kcolorchooser-24.12.0
pushd ..
cp -a kcolorchooser-24.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735233242
mkdir -p clr-build
pushd clr-build
